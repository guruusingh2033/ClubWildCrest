    ...
    public class WineController : Controller
    {
        ...
        public ActionResult Wine_BillDetailsByBillNo(int id)
        {
            ...
            if (data != null)
            {
                ...
                var billmode = context.tbl_WineBillingMode.Where(x => x.Wine_Bill_Number == id).ToList();
        ...
        public JsonResult CloseOrder(int tableID, string discount,double paymentModeCash = 0.0, double paymentModePaytm = 0.0, double paymentModeCard = 0.0, double Balance = 0.0)
        {
            ...
            if (menusData != null)
            {
                ...
                {
                    tbl_WineBillingMode model = new tbl_WineBillingMode();
                    model.Wine_Bill_Number = menusData.Bill_Number;
                    model.Amount = paymentModeCash - Balance;
                    model.Mode_Of_Pay = "Cash";
                    context.tbl_WineBillingMode.Add(model);
                    context.SaveChanges();
                }
